...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{center}
  \parbox{6.762in}{I am a developer with a strong academic background, as well as commercial experience in algorithmics and mathematics. I enjoy spending time in front of a whiteboard just as much as in front of a keyboard, predicting problems before they become blockers. In my spare time I enjoy developing intelligent agents for online games, listening to live music, and trying to explain to my mom what it is I do for a living.}
  \end{center}
...
\begin{itemize}
\item
	\ressubheading{PointsBet Australia}{Melbourne, AU}{Software Developer}{July 2017 - Current}
	
	PointsBet is a young sports betting startup with a unique value proposition offering of spread betting to Australian audience. It is a member of Microsoft's BizSpark program and is heavily reliant on Azure's offering.

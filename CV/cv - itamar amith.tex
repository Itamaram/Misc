...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{center}
  \parbox{6.762in}{I am a software engineer with a strong academic background, as well as commercial experience in algorithmics and mathematics. I enjoy spending time in front of a whiteboard just as much as in front of a keyboard, predicting problems before they become blockers. In my spare time I enjoy playing with IoT devices, developing intelligent agents for online games, and listening to live music.}
  \end{center}
...
\begin{itemize}
\item
	\ressubheading{Carsales.com}{Melbourne, AU}{Solutions Architect}{September 2015 - Current}

	While still actively developing Ryvuss, my expertise is further leveraged to assist other teams in designing and implementing software solutions as well as help improve existing ones. My major achievments while on in thie role so far are:
	\begin{itemize}
